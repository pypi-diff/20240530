# Comparing `tmp/flet_pyodide-0.23.0.dev2931.tar.gz` & `tmp/flet_pyodide-0.9.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flet_pyodide-0.23.0.dev2931.tar", max compression
+gzip compressed data, was "flet_pyodide-0.9.0.tar", max compression
```

## Comparing `flet_pyodide-0.23.0.dev2931.tar` & `flet_pyodide-0.9.0.tar`

### file list

```diff
@@ -1,10 +1,10 @@
--rw-r--r--   0        0        0     2264 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/README.md
--rw-r--r--   0        0        0      646 2024-05-30 20:35:40.955357 flet_pyodide-0.23.0.dev2931/pyproject.toml
--rw-r--r--   0        0        0      193 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/src/flet/__init__.py
--rw-r--r--   0        0        0       31 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/src/flet/canvas/__init__.py
--rw-r--r--   0        0        0     2169 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/src/flet/flet.py
--rw-r--r--   0        0        0       55 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/src/flet/matplotlib_chart.py
--rw-r--r--   0        0        0       47 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/src/flet/plotly_chart.py
--rw-r--r--   0        0        0     3581 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/src/flet/pyodide_connection.py
--rw-r--r--   0        0        0      103 2024-05-30 20:34:57.126607 flet_pyodide-0.23.0.dev2931/src/flet/version.py
--rw-r--r--   0        0        0     3060 1970-01-01 00:00:00.000000 flet_pyodide-0.23.0.dev2931/PKG-INFO
...
### Comparing `flet_pyodide-0.23.0.dev2931/README.md` & `flet_pyodide-0.9.0/README.md`

 * *Files identical despite different names*

### Comparing `flet_pyodide-0.23.0.dev2931/pyproject.toml` & `flet_pyodide-0.9.0/pyproject.toml`
...
### Comparing `flet_pyodide-0.23.0.dev2931/src/flet/flet.py` & `flet_pyodide-0.9.0/src/flet/flet.py`
...
### Comparing `flet_pyodide-0.23.0.dev2931/src/flet/pyodide_connection.py` & `flet_pyodide-0.9.0/src/flet/pyodide_connection.py`
...
### Comparing `flet_pyodide-0.23.0.dev2931/PKG-INFO` & `flet_pyodide-0.9.0/PKG-INFO`
