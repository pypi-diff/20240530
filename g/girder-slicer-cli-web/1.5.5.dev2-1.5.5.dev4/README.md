# Comparing `tmp/girder_slicer_cli_web-1.5.5.dev2.tar.gz` & `tmp/girder_slicer_cli_web-1.5.5.dev4.tar.gz`
...
### Comparing `girder_slicer_cli_web-1.5.5.dev2/example-average-color/cli_list.py` & `girder_slicer_cli_web-1.5.5.dev4/example-average-color/cli_list.py`
...
### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/stylesheets/panel.styl` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/stylesheets/panel.styl`
...
### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/templates/jobsListWidget.pug` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/templates/jobsListWidget.pug`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/templates/panelGroup.pug` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/templates/panelGroup.pug`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/templates/regionWidget.pug` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/templates/regionWidget.pug`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/templates/uploadImageDialog.pug` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/templates/uploadImageDialog.pug`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/templates/widget.pug` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/templates/widget.pug`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/utils.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/utils.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/CollectionView.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/CollectionView.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/ConfigView.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/ConfigView.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/ControlWidget.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/ControlWidget.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/ControlsPanel.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/ControlsPanel.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/ItemSelectorWidget.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/ItemSelectorWidget.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/ItemView.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/ItemView.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/JobsListWidget.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/JobsListWidget.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/JobsPanel.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/JobsPanel.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/OutputParameterDialog.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/OutputParameterDialog.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/Panel.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/Panel.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/PanelGroup.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/PanelGroup.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/web_client/views/utils.js` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/web_client/views/utils.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/slicer_cli_web/worker_tools.py` & `girder_slicer_cli_web-1.5.5.dev4/slicer_cli_web/worker_tools.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/.dockerignore` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/.dockerignore`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Dockerfile` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Dockerfile`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example1/Example1.json` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example1/Example1.json`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example1/Example1.py` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example1/Example1.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example1/Example1.xml` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example1/Example1.xml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example1/Example1.yaml` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example1/Example1.yaml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example2/Example2.json` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example2/Example2.json`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example2/Example2.py` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example2/Example2.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example2/Example2.xml` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example2/Example2.xml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example2/Example2.yaml` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example2/Example2.yaml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example3/Example3.json` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example3/Example3.json`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example3/Example3.py` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example3/Example3.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example3/Example3.xml` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example3/Example3.xml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/Example3/Example3.yaml` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/Example3/Example3.yaml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/ExampleProgress/ExampleProgress.json` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/ExampleProgress/ExampleProgress.json`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/ExampleProgress/ExampleProgress.py` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/ExampleProgress/ExampleProgress.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/ExampleProgress/progress_helper.py` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/ExampleProgress/progress_helper.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/cli_list.json` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/cli_list.json`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/small-docker/cli_list.py` & `girder_slicer_cli_web-1.5.5.dev4/small-docker/cli_list.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/conftest.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/data/ExampleSpec.xml` & `girder_slicer_cli_web-1.5.5.dev4/tests/data/ExampleSpec.xml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/data/parser_params_advanced.json` & `girder_slicer_cli_web-1.5.5.dev4/tests/data/parser_params_advanced.json`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/data/parser_params_advanced.xml` & `girder_slicer_cli_web-1.5.5.dev4/tests/data/parser_params_advanced.xml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/data/parser_params_advanced.yaml` & `girder_slicer_cli_web-1.5.5.dev4/tests/data/parser_params_advanced.yaml`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/girder_worker_plugin/test_cli_progress.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/girder_worker_plugin/test_cli_progress.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/girder_worker_plugin/test_direct_docker_run.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/girder_worker_plugin/test_direct_docker_run.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/test_batch.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/test_batch.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/test_config.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/test_config.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/test_docker.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/test_docker.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/test_load.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/test_load.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/test_parser.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/test_parser.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/test_rest_slicer_cli.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/test_rest_slicer_cli.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/test_web_client.py` & `girder_slicer_cli_web-1.5.5.dev4/tests/test_web_client.py`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/web_client_specs/configViewSpec.js` & `girder_slicer_cli_web-1.5.5.dev4/tests/web_client_specs/configViewSpec.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/web_client_specs/containerViewSpec.js` & `girder_slicer_cli_web-1.5.5.dev4/tests/web_client_specs/containerViewSpec.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/web_client_specs/dockerTaskSpec.js` & `girder_slicer_cli_web-1.5.5.dev4/tests/web_client_specs/dockerTaskSpec.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/web_client_specs/itemSelectorWidgetSpec.js` & `girder_slicer_cli_web-1.5.5.dev4/tests/web_client_specs/itemSelectorWidgetSpec.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/web_client_specs/panelGroupSpec.js` & `girder_slicer_cli_web-1.5.5.dev4/tests/web_client_specs/panelGroupSpec.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/web_client_specs/parseSpec.js` & `girder_slicer_cli_web-1.5.5.dev4/tests/web_client_specs/parseSpec.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tests/web_client_specs/widgetSpec.js` & `girder_slicer_cli_web-1.5.5.dev4/tests/web_client_specs/widgetSpec.js`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/tox.ini` & `girder_slicer_cli_web-1.5.5.dev4/tox.ini`

 * *Files identical despite different names*

### Comparing `girder_slicer_cli_web-1.5.5.dev2/utils/xmltojson.py` & `girder_slicer_cli_web-1.5.5.dev4/utils/xmltojson.py`
