# Comparing `tmp/myfunctions_thejondaw-0.0.3.tar.gz` & `tmp/myfunctions_thejondaw-0.0.4.tar.gz`
...
## Comparing `myfunctions_thejondaw-0.0.3.tar` & `myfunctions_thejondaw-0.0.4.tar`
...
### Comparing `myfunctions_thejondaw-0.0.3/setup.py` & `myfunctions_thejondaw-0.0.4/setup.py`
