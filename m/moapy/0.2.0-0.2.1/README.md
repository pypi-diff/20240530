# Comparing `tmp/moapy-0.2.0.tar.gz` & `tmp/moapy-0.2.1.tar.gz`
...
### Comparing `moapy-0.2.0/README.md` & `moapy-0.2.1/README.md`
...
### Comparing `moapy-0.2.0/setup.py` & `moapy-0.2.1/setup.py`
