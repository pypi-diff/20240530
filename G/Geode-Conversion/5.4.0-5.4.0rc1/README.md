# Comparing `tmp/Geode_Conversion-5.4.0-cp39-cp39-manylinux2014_x86_64.whl.zip` & `tmp/Geode_Conversion-5.4.0rc1-cp39-cp39-win_amd64.whl.zip`

## zipinfo {}

```diff
@@ -1,10 +1,10 @@
-Zip file size: 1639428 bytes, number of entries: 8
--rw-r--r--  2.0 unx       67 b- defN 24-May-30 05:28 geode_conversion/__init__.py
--rw-r--r--  2.0 unx      172 b- defN 24-May-30 05:28 geode_conversion/model.py
--rwxr-xr-x  2.0 unx   167512 b- defN 24-May-30 05:28 geode_conversion/lib64/geode_conversion_py_model.cpython-39-x86_64-linux-gnu.so
--rwxr-xr-x  2.0 unx  3627120 b- defN 24-May-30 05:28 geode_conversion/lib64/libGeode-Conversion_model.so
--rw-r--r--  2.0 unx     1931 b- defN 24-May-30 05:28 Geode_Conversion-5.4.0.dist-info/METADATA
--rw-r--r--  2.0 unx      103 b- defN 24-May-30 05:28 Geode_Conversion-5.4.0.dist-info/WHEEL
--rw-r--r--  2.0 unx       17 b- defN 24-May-30 05:28 Geode_Conversion-5.4.0.dist-info/top_level.txt
--rw-rw-r--  2.0 unx      748 b- defN 24-May-30 05:28 Geode_Conversion-5.4.0.dist-info/RECORD
-8 files, 3797670 bytes uncompressed, 1638104 bytes compressed:  56.9%
...
-Filename: Geode_Conversion-5.4.0.dist-info/METADATA
+Filename: Geode_Conversion-5.4.0rc1.dist-info/METADATA
 Comment: 
 
-Filename: Geode_Conversion-5.4.0.dist-info/WHEEL
+Filename: Geode_Conversion-5.4.0rc1.dist-info/WHEEL
 Comment: 
 
-Filename: Geode_Conversion-5.4.0.dist-info/top_level.txt
+Filename: Geode_Conversion-5.4.0rc1.dist-info/top_level.txt
 Comment: 
 
-Filename: Geode_Conversion-5.4.0.dist-info/RECORD
...
## Comparing `Geode_Conversion-5.4.0.dist-info/METADATA` & `Geode_Conversion-5.4.0rc1.dist-info/METADATA`
...
```diff
@@ -1,11 +1,12 @@
-Metadata-Version: 2.1 Name: Geode-Conversion Version: 5.4.0 Summary: Conversion
...
-text/markdown Requires-Dist: opengeode-core ==14.*,>=14.21.1
