# Comparing `tmp/composio_crewai-0.3.0.tar.gz` & `tmp/composio_crewai-0.3.1.tar.gz`
...
## Comparing `composio_crewai-0.3.0.tar` & `composio_crewai-0.3.1.tar`
...
### Comparing `composio_crewai-0.3.0/PKG-INFO` & `composio_crewai-0.3.1/PKG-INFO`
...
### Comparing `composio_crewai-0.3.0/README.md` & `composio_crewai-0.3.1/README.md`

 * *Files identical despite different names*

### Comparing `composio_crewai-0.3.0/composio_crewai.egg-info/PKG-INFO` & `composio_crewai-0.3.1/composio_crewai.egg-info/PKG-INFO`
...
### Comparing `composio_crewai-0.3.0/setup.py` & `composio_crewai-0.3.1/setup.py`
