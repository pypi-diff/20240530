# Comparing `tmp/jpfiddle_extension-0.1.7.tar.gz` & `tmp/jpfiddle_extension-0.1.8.tar.gz`
...
### Comparing `jpfiddle_extension-0.1.7/RELEASE.md` & `jpfiddle_extension-0.1.8/RELEASE.md`
