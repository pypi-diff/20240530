# Comparing `tmp/jmock-0.0.2.tar.gz` & `tmp/jmock-0.0.3.tar.gz`
...
## Comparing `jmock-0.0.2.tar` & `jmock-0.0.3.tar`
...
### Comparing `jmock-0.0.2/jmock/aiFunctions.py` & `jmock-0.0.3/jmock/aiFunctions.py`

 * *Files identical despite different names*

### Comparing `jmock-0.0.2/setup.py` & `jmock-0.0.3/setup.py`
